...
+ (id)keyframe2DWithPoint:(struct CGPoint)arg1 atTime:(double)arg2 offset:(int)arg3;
- (id)initKeyframe2DWithPoint:(struct CGPoint)arg1 atTime:(double)arg2 offset:(int)arg3;

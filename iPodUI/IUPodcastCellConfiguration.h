...
@property(copy, nonatomic) NSString *displayReleaseDate; // @synthesize displayReleaseDate=_displayReleaseDate;
@property(copy, nonatomic) NSString *fullDisplayTitle; // @synthesize fullDisplayTitle=_fullDisplayTitle;

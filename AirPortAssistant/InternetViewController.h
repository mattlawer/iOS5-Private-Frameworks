...
@interface InternetViewController : AssistantSubUIViewController <UIScrollViewDelegate>
{
    ...
    CDStruct_a9370ada targetDevice;
    CDStruct_a9370ada sourceDevice;
}
...
- (id)insetImageForDeviceDiagramInfo:(CDStruct_a9370ada *)arg1;
- (id)deviceImageForDeviceDiagramInfo:(CDStruct_a9370ada *)arg1;
- (void)determineInfoForProductID:(unsigned int)arg1 deviceDiagramInfo:(CDStruct_a9370ada *)arg2;
